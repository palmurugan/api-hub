...
public class SearchServiceImpl implements SearchService {
    ...
    private static final String SEARCH_SERVICE_URI = "/api/v1/provider-services/search";

    private final WebClientService webClientService;

    @Override
    public Mono<PageResponse<SearchServiceResponse>> searchServiceByKeyword(SearchRequest request) {
